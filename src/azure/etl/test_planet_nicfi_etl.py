...
def test_integration():
    geometry = shapely.geometry.box(-60.64453124152092, -1.2303741772055612, -60.468749991545344, -1.054627942073222)
    ...
    results = etl.process_geometry(geometry, start_datetime, end_datetime, planet_api_key, asset_credential, nicfi_table_credential)
